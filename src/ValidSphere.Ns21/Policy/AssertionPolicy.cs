...
/// </summary>
/// <remarks>
/// Instance-based variant of the main policy contract for runtimes without
/// static-virtual dispatch. Constrained calls on the policy struct are
/// allocation-free, like the static variant.
/// </remarks>
public interface IAssertionPolicy {
    ...
    [DoesNotReturn]
    void Fail(AssertionContext context, string message);
    ...
    /// <param name="message">The failure message.</param>
    [DoesNotReturn]
    void FailNull(AssertionContext context, string message);
    ...
    /// <param name="message">The failure message.</param>
    [DoesNotReturn]
    void FailOutOfRange<T>(AssertionContext context, T actualValue, string message);
}
...
public readonly struct IsPolicy : IAssertionPolicy {
    ...
    public void Fail(AssertionContext context, string message) {
    ...
    [StackTraceHidden]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void FailNull(AssertionContext context, string message) {
        throw new AssertException(message, context);
    }
    ...
    [StackTraceHidden]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public void FailOutOfRange<T>(AssertionContext context, T actualValue, string message) {
        throw new AssertException(message, context);
    }
}
